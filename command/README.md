...
Επαναλαμβάνοντας την ίδια διαδικασία αποσύνδεσης και σύνδεσης του level7 γράφουμε την εντολή find / -type f -user bandit7 -group bandit6 -size 33c καθώς πρέπει να έχει τα συγκεκριμένα χαρακτηριστικά και ψάχνουμε το κωδικό γα το συγκεκριμένο level.
